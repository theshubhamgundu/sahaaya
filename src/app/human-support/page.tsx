    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
            <h2 className="text-3xl font-semibold text-foreground">Human Support Chat</h2>
            <p className="text-muted-foreground">Connect and chat live with a trained supporter.</p>
        </div>
