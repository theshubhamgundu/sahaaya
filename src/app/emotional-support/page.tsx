    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
            <h2 className="text-3xl font-semibold text-foreground">Emotional Support</h2>
            <p className="text-muted-foreground">Share your experience. We are here to listen and provide comfort.</p>
        </div>
        <UserInputForm />
